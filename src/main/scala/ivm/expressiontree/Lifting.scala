...
object Lifting
  ...
  with TraversableOps with ForceOps with IterableOps with CollectionSeqOps with MapOps with SetOps with TypeFilterOps with NumOps with BaseTypesOps with ExpSugar
{
